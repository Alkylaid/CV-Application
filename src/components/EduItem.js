            ...
            <div key={edu.id}>
              <div className="item edu" id={edu.id}>
                ...
                <div>
                  <span
                    ...
                    onClick={() => this.handleClick(edu.id)}
                  ></span>
                  <span
              ...
              <div id={`${edu.id}_edit`} className="edit-edu-item">
                <input
                  ...
                  value={edu.name}
                  onChange={(e) =>
                    this.props.edit(edu.id, 'inst-edit-field', e)
                  }
                ...
                <textarea
                  ...
                  value={edu.city}
                  onChange={(e) =>
                    this.props.edit(edu.id, 'city-edit-field', e)
                  }
                ...
                <input
                  ...
                  value={edu.major}
                  onChange={(e) =>
                    this.props.edit(edu.id, 'major-edit-field', e)
                  }
                ...
                <div className="date-fields">
                  <input
                    ...
                    value={edu.from}
                    onChange={(e) =>
                      this.props.edit(edu.id, 'from-edit-field', e)
                    }
                    placeholder="From"
                    required
                  />
                  <input
                    ...
                    value={edu.to}
                    onChange={(e) =>
                      this.props.edit(edu.id, 'to-edit-field', e)
                    }
                    placeholder="To"
                    required
                  />
                ...
                <input
                  ...
                  onClick={() => this.handleSave(edu.id)}
                  value="Save"
                />
              </div>
            </div>
